...
- Write the installation and execution scripts: Write 2 bash scripts (.sh) where the first one allows to install dependencies and prepare the environment, while the second one launches test case execution.
